---
title: "Tunnel TCP services"
linkTitle: "Tunnel TCP services"
weight: 60
aliases:
  - /docs/concepts/overview/services/
description: >
  Expose a local or remote TCP service to the network and connect to it from another peer.
---

If you have not done this before, the step-by-step version is
[Share a service between two hosts](../../tutorials/share-a-service/).
