---
title: "Network configuration and tokens"
linkTitle: "Network config"
weight: 30
aliases:
  - /docs/concepts/token/
description: >
  Every field of the network configuration file, and how it maps to a token.
---
...
See [the Architecture section](../../explanation/architecture/) for more information.
